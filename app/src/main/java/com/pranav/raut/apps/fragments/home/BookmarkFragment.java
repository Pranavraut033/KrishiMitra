 ...
 * For KrishiMitra
 */
public class BookmarkFragment extends GFragment {
    ...
    public View onCreateView(
        ...
        mParent = inflater.inflate(R.layout.home_bookmark_fragment, container, false);
    ...
    private void updateList(List<DocumentSnapshot> list) {
        ...
        for (DocumentSnapshot snapshot : list) {
            ...
            if (mUser.getBookmarks().indexOf(schema.getId()) != -1)
                posts.add(schema);
        }
